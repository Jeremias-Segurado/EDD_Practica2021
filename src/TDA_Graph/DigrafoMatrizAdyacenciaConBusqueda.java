 ...
 * Este grafo esta preparado para la busqueda en profundidad DFS y BFS.
 * @author Jeremias
 *
 * @param <V> Rotulo de los vertices.
 * @param <E> Rotulo de los arcos(arcos pesados).
 */
public class DigrafoMatrizAdyacenciaConBusqueda<V,E> implements GraphD<V, E> {
	...
	private class Vertice<V> implements Vertex<V>{
		...
		public void setEstado(boolean estado) { this.visitado = estado; }			
	}
	...
	public DigrafoMatrizAdyacenciaConBusqueda(int n) {
